	...
	double ang1, double ang2, double rad )
{
  ...
  if( fabs( ang2- ang1) < 360.00001)
  {
	...
	mreq *= sizeof(int);
	mem_realloc( (void *)&data.itag, mreq , 16);
/* Reallocate wire buffers */
	mreq = (size_t)data.n;
	mreq *= sizeof(double);
	mem_realloc( (void *)&data.x1, mreq , 17);
	mem_realloc( (void *)&data.y1, mreq , 18);
	mem_realloc( (void *)&data.z1, mreq , 19);
	mem_realloc( (void *)&data.x2, mreq , 20);
	mem_realloc( (void *)&data.y2, mreq , 21);
	mem_realloc( (void *)&data.z2, mreq , 22);
	mem_realloc( (void *)&data.bi, mreq , 23);
...
void conect( int ignd )
{
  ...
  if( data.n != 0)
  {
	...
	mreq *= sizeof(int);
	mem_realloc( (void *)&data.icon1, mreq , 25);
	mem_realloc( (void *)&data.icon2, mreq , 26);
  ...
  mem_realloc( (void *)&segj.jco, mreq , 27);
	  ...
	  if( (ix != 0) && (ix != (j+1)) && (ix <= PCHCON) )
	  {
		do
		{
		  ...
		  if( ic >= segj.maxcon )
		  {
			...
			mreq = (size_t)segj.maxcon;
			mreq *= sizeof(int);
			mem_realloc( (void *)&segj.jco, mreq , 28);
		  }
  ...
  mreq = (size_t)segj.maxcon;
  mreq *= sizeof(double);
  mem_realloc( (void *)&segj.ax, mreq , 29);
  mem_realloc( (void *)&segj.bx, mreq , 30);
  mem_realloc( (void *)&segj.cx, mreq , 31);

  //  for (int i=0;i<segj.maxcon;++i) {
  //    printf("\nsegj.segj[%d]=%d",i,segj.jco[i]);
  //  }
  return;
}
	...
	switch( gm_num )
	{
	  ...
	  case 4: /* "ge" card, terminate structure geometry input. */
		...
		if( data.n != 0)
		{
		  ...
		  mreq = (size_t)data.n;
		  mreq *= sizeof(double);
		  mem_realloc( (void *)&data.si, mreq , 32);
		  mem_realloc( (void *)&data.sab, mreq , 33);
		  mem_realloc( (void *)&data.cab, mreq , 34);
		  mem_realloc( (void *)&data.salp, mreq , 35);
		  mem_realloc( (void *)&data.x, mreq , 36);
		  mem_realloc( (void *)&data.y, mreq , 37);
		  mem_realloc( (void *)&data.z, mreq , 38);
		  ...
		  for( i = 0; i < data.n; i++ )
		  {
			...
			if( plot.iplp1 == 1)
			 notQfprintf( plot_fp, "%12.4E %12.4E %12.4E "
	...
	double a2, double b2, double rad, int ns, int itg )
{
  ...
  mreq = (size_t)(data.n + data.m);
  mreq *= sizeof(int);
  mem_realloc( (void *)&data.itag, mreq , 50);

  /* Reallocate wire buffers */
  mreq = (size_t)data.n;
  mreq *= sizeof(double);
  mem_realloc( (void *)&data.x1, mreq , 51);
  mem_realloc( (void *)&data.y1, mreq , 52);
  mem_realloc( (void *)&data.z1, mreq , 53);
  mem_realloc( (void *)&data.x2, mreq , 54);
  mem_realloc( (void *)&data.y2, mreq , 55);
  mem_realloc( (void *)&data.z2, mreq , 56);
  mem_realloc( (void *)&data.bi, mreq , 57);
	...
	double ys, double zs, int its, int nrpt, int itgi )
{
  ...
  if( data.n > 0)
  {
	...
	else
	{
	  ...
	  mreq *= sizeof(int);
	  mem_realloc( (void *)&data.itag, mreq , 58);

	  /* Reallocate wire buffers */
	  mreq = (size_t)(data.n + (data.n + 1 - i1) * nrpt);
	  mreq *= sizeof(double);
	  mem_realloc( (void *)&data.x1, mreq , 59);
	  mem_realloc( (void *)&data.y1, mreq , 60);
	  mem_realloc( (void *)&data.z1, mreq , 61);
	  mem_realloc( (void *)&data.x2, mreq , 63);
	  mem_realloc( (void *)&data.y2, mreq , 64);
	  mem_realloc( (void *)&data.z2, mreq , 65);
	  mem_realloc( (void *)&data.bi, mreq , 66);
	}
  ...
  if( data.m > 0)
  {
	...
	mreq *= sizeof(double);
	mem_realloc( (void *)&data.px, mreq , 70);
	mem_realloc( (void *)&data.py, mreq , 71);
	mem_realloc( (void *)&data.pz, mreq , 72);
	mem_realloc( (void *)&data.t1x, mreq , 73);
	mem_realloc( (void *)&data.t1y, mreq , 74);
	mem_realloc( (void *)&data.t1z, mreq , 75);
	mem_realloc( (void *)&data.t2x, mreq , 76);
	mem_realloc( (void *)&data.t2y, mreq , 77);
	mem_realloc( (void *)&data.t2z, mreq , 78);
	mem_realloc( (void *)&data.pbi, mreq , 79);
	mem_realloc( (void *)&data.psalp, mreq , 80);
	...
	double ax4, double ay4, double az4 )
{
  ...
  mreq = (size_t)data.m;
  mreq *= sizeof(double);
  mem_realloc( (void *)&data.px, mreq , 81);
  mem_realloc( (void *)&data.py, mreq , 82);
  mem_realloc( (void *)&data.pz, mreq , 83);
  mem_realloc( (void *)&data.t1x, mreq , 84);
  mem_realloc( (void *)&data.t1y, mreq , 85);
  mem_realloc( (void *)&data.t1z, mreq , 86);
  mem_realloc( (void *)&data.t2x, mreq , 87);
  mem_realloc( (void *)&data.t2y, mreq , 88);
  mem_realloc( (void *)&data.t2z, mreq , 89);
  mem_realloc( (void *)&data.pbi, mreq , 90);
  mem_realloc( (void *)&data.psalp, mreq , 91);
  ...
  if( nx != 0)
  {
	...
	mreq = (size_t)data.m;
	mreq *= sizeof(double);
	mem_realloc( (void *)&data.px, mreq , 100);
	mem_realloc( (void *)&data.py, mreq , 101);
	mem_realloc( (void *)&data.pz, mreq , 102);
	mem_realloc( (void *)&data.t1x, mreq , 103);
	mem_realloc( (void *)&data.t1y, mreq , 104);
	mem_realloc( (void *)&data.t1z, mreq , 105);
	mem_realloc( (void *)&data.t2x, mreq , 106);
	mem_realloc( (void *)&data.t2y, mreq , 107);
	mem_realloc( (void *)&data.t2z, mreq , 108);
	mem_realloc( (void *)&data.pbi, mreq , 109);
	mem_realloc( (void *)&data.psalp, mreq , 110);
...
void subph( int nx, int ny )
{
  ...
  mreq = (size_t)data.m;
  mreq *= sizeof(double);
  mem_realloc( (void *)&data.px, mreq , 111);
  mem_realloc( (void *)&data.py, mreq , 112);
  mem_realloc( (void *)&data.pz, mreq , 113);
  mem_realloc( (void *)&data.t1x, mreq , 114);
  mem_realloc( (void *)&data.t1y, mreq , 115);
  mem_realloc( (void *)&data.t1z, mreq , 116);
  mem_realloc( (void *)&data.t2x, mreq , 117);
  mem_realloc( (void *)&data.t2y, mreq , 118);
  mem_realloc( (void *)&data.t2z, mreq , 119);
  mem_realloc( (void *)&data.pbi, mreq , 120);
  mem_realloc( (void *)&data.psalp, mreq , 121);
  mreq = (size_t)(data.n + data.m);
  mreq *= sizeof(int);
  mem_realloc( (void *)&data.icon1, mreq , 122);
  mem_realloc( (void *)&data.icon2, mreq , 123);
...
void reflc( int ix, int iy, int iz, int itx, int nop )
{
  ...
  if( ix >= 0)
  {
	...
	if( iz != 0)
	{
	  ...
	  if( data.n > 0 )
	  {
		...
		mreq *= sizeof(int);
		mem_realloc( (void *)&data.itag, mreq , 130);

		/* Reallocate wire buffers */
		mreq = (size_t)(2 * data.n);
		mreq *= sizeof(double);
		mem_realloc( (void *)&data.x1, mreq , 131);
		mem_realloc( (void *)&data.y1, mreq , 132);
		mem_realloc( (void *)&data.z1, mreq , 133);
		mem_realloc( (void *)&data.x2, mreq , 134);
		mem_realloc( (void *)&data.y2, mreq , 135);
		mem_realloc( (void *)&data.z2, mreq , 136);
		mem_realloc( (void *)&data.bi, mreq , 137);
	  ...
	  if( data.m > 0 )
	  {
		...
		mreq *= sizeof(double);
		mem_realloc( (void *)&data.px, mreq , 140);
		mem_realloc( (void *)&data.py, mreq , 141);
		mem_realloc( (void *)&data.pz, mreq , 142);
		mem_realloc( (void *)&data.t1x, mreq , 143);
		mem_realloc( (void *)&data.t1y, mreq , 144);
		mem_realloc( (void *)&data.t1z, mreq , 145);
		mem_realloc( (void *)&data.t2x, mreq , 146);
		mem_realloc( (void *)&data.t2y, mreq , 147);
		mem_realloc( (void *)&data.t2z, mreq , 148);
		mem_realloc( (void *)&data.pbi, mreq , 149);
		mem_realloc( (void *)&data.psalp, mreq , 150);
	...
	if( iy != 0)
	{
	  if( data.n > 0)
	  {
		...
		mreq = (size_t)(2 * data.n + data.m);
		mreq *= sizeof(int);
		mem_realloc( (void *)&data.itag, mreq , 160);

		/* Reallocate wire buffers */
		mreq = (size_t)(2 * data.n);
		mreq *= sizeof(double);
		mem_realloc( (void *)&data.x1, mreq , 161);
		mem_realloc( (void *)&data.y1, mreq , 162);
		mem_realloc( (void *)&data.z1, mreq , 163);
		mem_realloc( (void *)&data.x2, mreq , 164);
		mem_realloc( (void *)&data.y2, mreq , 165);
		mem_realloc( (void *)&data.z2, mreq , 166);
		mem_realloc( (void *)&data.bi, mreq , 167);
	  ...
	  if( data.m > 0 )
	  {
		...
		mreq = (size_t)(2 * data.m);
		mreq *= sizeof(double);
		mem_realloc( (void *)&data.px, mreq , 170);
		mem_realloc( (void *)&data.py, mreq , 171);
		mem_realloc( (void *)&data.pz, mreq , 172);
		mem_realloc( (void *)&data.t1x, mreq , 173);
		mem_realloc( (void *)&data.t1y, mreq , 174);
		mem_realloc( (void *)&data.t1z, mreq , 175);
		mem_realloc( (void *)&data.t2x, mreq , 176);
		mem_realloc( (void *)&data.t2y, mreq , 177);
		mem_realloc( (void *)&data.t2z, mreq , 178);
		mem_realloc( (void *)&data.pbi, mreq , 170);
		mem_realloc( (void *)&data.psalp, mreq , 180);
	...
	if( data.n > 0 )
	{
	  ...
	  mreq = (size_t)(2 * data.n + data.m);
	  mreq *= sizeof(int);
	  mem_realloc( (void *)&data.itag, mreq , 200);

	  /* Reallocate wire buffers */
	  mreq = (size_t)(2 * data.n);
	  mreq *= sizeof(double);
	  mem_realloc( (void *)&data.x1, mreq , 201);
	  mem_realloc( (void *)&data.y1, mreq , 202);
	  mem_realloc( (void *)&data.z1, mreq , 203);
	  mem_realloc( (void *)&data.x2, mreq , 204);
	  mem_realloc( (void *)&data.y2, mreq , 205);
	  mem_realloc( (void *)&data.z2, mreq , 206);
	  mem_realloc( (void *)&data.bi, mreq , 207);
	...
	mreq = (size_t)(2 * data.m);
	mreq *= sizeof(double);
	mem_realloc( (void *)&data.px, mreq , 210);
	mem_realloc( (void *)&data.py, mreq , 211);
	mem_realloc( (void *)&data.pz, mreq , 212);
	mem_realloc( (void *)&data.t1x, mreq , 213);
	mem_realloc( (void *)&data.t1y, mreq , 214);
	mem_realloc( (void *)&data.t1z, mreq , 215);
	mem_realloc( (void *)&data.t2x, mreq , 216);
	mem_realloc( (void *)&data.t2y, mreq , 217);
	mem_realloc( (void *)&data.t2z, mreq , 218);
	mem_realloc( (void *)&data.pbi, mreq , 219);
	mem_realloc( (void *)&data.psalp, mreq , 220);
  ...
  if( data.n > 0)
  {
	...
	mreq = (size_t)(data.n + data.m);
	mreq *= sizeof(int);
	mem_realloc( (void *)&data.itag, mreq , 220);

	/* Reallocate wire buffers */
	mreq = (size_t)data.n;
	mreq *= sizeof(double);
	mem_realloc( (void *)&data.x1, mreq , 221);
	mem_realloc( (void *)&data.y1, mreq , 222);
	mem_realloc( (void *)&data.z1, mreq , 223);
	mem_realloc( (void *)&data.x2, mreq , 224);
	mem_realloc( (void *)&data.y2, mreq , 225);
	mem_realloc( (void *)&data.z2, mreq , 226);
	mem_realloc( (void *)&data.bi, mreq , 227);
  ...
  mreq = (size_t)data.m;
  mreq *= sizeof(double);
  mem_realloc( (void *)&data.px, mreq  , 230);
  mem_realloc( (void *)&data.py, mreq  , 231);
  mem_realloc( (void *)&data.pz, mreq , 232);
  mem_realloc( (void *)&data.t1x, mreq , 233);
  mem_realloc( (void *)&data.t1y, mreq , 234);
  mem_realloc( (void *)&data.t1z, mreq , 235);
  mem_realloc( (void *)&data.t2x, mreq , 236);
  mem_realloc( (void *)&data.t2y, mreq , 237);
  mem_realloc( (void *)&data.t2z, mreq , 238);
  mem_realloc( (void *)&data.pbi, mreq , 239);
  mem_realloc( (void *)&data.psalp, mreq , 240);
	...
	double rdel, double rrad, int ns, int itg )
{
  ...
  mreq = (size_t)(data.n + data.m);
  mreq *= sizeof(int);
  mem_realloc( (void *)&data.itag, mreq , 250);

  /* Reallocate wire buffers */
  mreq = (size_t)data.n;
  mreq *= sizeof(double);
  mem_realloc( (void *)&data.x1, mreq , 251);
  mem_realloc( (void *)&data.y1, mreq , 252);
  mem_realloc( (void *)&data.z1, mreq , 253);
  mem_realloc( (void *)&data.x2, mreq , 254);
  mem_realloc( (void *)&data.y2, mreq , 255);
  mem_realloc( (void *)&data.z2, mreq , 256);
  mem_realloc( (void *)&data.bi, mreq , 256);
